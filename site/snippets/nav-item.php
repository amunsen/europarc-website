...
<a href="<?php echo site()->multilang() ? site()->url('en') : site()->url(); ?>/<?php echo $link->href() ?>" target="_blank" class="flex-1 group flex flex-col col-span-1 sm:col-span-1 lg:col-span-2 max-w-[560px]">
